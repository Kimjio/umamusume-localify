...
#ifndef DO_API_NEW
#define DO_API_NEW(r, n, p) DO_API(r,n,p)
#endif
...
DO_API_NEW(void, il2cpp_memory_pool_set_region_size, (size_t size));
DO_API_NEW(size_t, il2cpp_memory_pool_get_region_size, ());
