...
namespace
{
	Il2CppMethodPointer ResourcesAPIInternal_Load_addr = nullptr;
...
static Il2CppObject* ResourcesAPIInternal_Load_hook(Il2CppString* path, Il2CppReflectionType* systemTypeInstance)
{
	...
	if (u16Name == il2cppstring(IL2CPP_STRING("ui/views/titleview")))
	{
		...
		{
			auto gameObj = reinterpret_cast<decltype(ResourcesAPIInternal_Load_hook)*>(ResourcesAPIInternal_Load_addr)(path, systemTypeInstance);
			auto getComponent = il2cpp_symbols::get_method_pointer<Il2CppObject * (*)(Il2CppObject*, Il2CppReflectionType*)>(gameObj->klass, "GetComponent", 1);
	...
	if (config::replace_to_custom_font)
	{
		...
		{
			auto object = reinterpret_cast<decltype(ResourcesAPIInternal_Load_hook)*>(ResourcesAPIInternal_Load_addr)(path, systemTypeInstance);
	...
	return reinterpret_cast<decltype(ResourcesAPIInternal_Load_hook)*>(ResourcesAPIInternal_Load_addr)(path, systemTypeInstance);
}

static void InitAddress()
{
	ResourcesAPIInternal_Load_addr = il2cpp_resolve_icall("UnityEngine.ResourcesAPIInternal::Load");
...
{
	if (il2cpp_resolve_icall("UnityEngine.Resources::Load()"))
	{
		il2cpp_add_internal_call("UnityEngine.Resources::Load", reinterpret_cast<Il2CppMethodPointer>(ResourcesAPIInternal_Load_hook));
	}
	else
	{
		il2cpp_add_internal_call("UnityEngine.ResourcesAPIInternal::Load", reinterpret_cast<Il2CppMethodPointer>(ResourcesAPIInternal_Load_hook));
	}
}
