...
namespace Localify
{
	...
	void NotificationManager::Init()
	{
		...
		auto transform = il2cpp_symbols::get_method_pointer<Il2CppObject * (*)(Il2CppObject*)>(_noticeCanvas->klass, "get_transform", 0)(_noticeCanvas);
		...
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, int)>(_Label->klass, "set_fontSize", 1)(_Label, config::character_system_text_caption_font_size);
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, int)>(_Label->klass, "set_resizeTextMaxSize", 1)(_Label, config::character_system_text_caption_font_size);
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, int)>(_Label->klass, "set_FontColor", 1)(_Label, GetEnumValue(ParseEnum(GetRuntimeType("umamusume.dll", "Gallop", "FontColorType"), config::character_system_text_caption_font_color.data())));
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, int)>(_Label->klass, "set_OutlineSize", 1)(_Label, GetEnumValue(ParseEnum(GetRuntimeType("umamusume.dll", "Gallop", "OutlineSizeType"), config::character_system_text_caption_outline_size.data())));
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, int)>(_Label->klass, "set_OutlineColor", 1)(_Label, GetEnumValue(ParseEnum(GetRuntimeType("umamusume.dll", "Gallop", "OutlineColorType"), config::character_system_text_caption_outline_color.data())));
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*)>(_Label->klass, "RebuildOutline", 0)(_Label);
		...
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, float)>(background->klass, "SetAlpha", 1)(background, config::character_system_text_caption_background_alpha);

		auto canvasGroupTransform = il2cpp_symbols::get_method_pointer<Il2CppObject * (*)(Il2CppObject*)>(canvasGroup->klass, "get_transform", 0)(canvasGroup);

		auto position = il2cpp_symbols::get_method_pointer<UnityEngine::Vector3(*)(Il2CppObject*)>(canvasGroupTransform->klass, "get_position", 0)(canvasGroupTransform);

		position.x = config::character_system_text_caption_position_x;
		position.y = config::character_system_text_caption_position_y;

		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, UnityEngine::Vector3)>(canvasGroupTransform->klass, "set_position", 1)(canvasGroupTransform, position);
		...
		if (gameObject)
		{
			il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, bool)>(gameObject->klass, "SetActive", 1)(gameObject, false);
	...
	void NotificationManager::Show(Il2CppString* text)
	{
		...
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, Il2CppString*)>(_Label->klass, "set_text", 1)(_Label, text);
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, float)>(canvasGroup->klass, "set_alpha", 1)(canvasGroup, 1);

		auto gameObject = UnityEngine::Component(notification).gameObject();
	...
	void NotificationManager::SetFontSize(int size)
	{
		...
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, int)>(_Label->klass, "set_fontSize", 1)(_Label, size);
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, int)>(_Label->klass, "set_resizeTextMaxSize", 1)(_Label, size);
	}
	...
	void NotificationManager::SetFontColor(il2cppstring color)
	{
		...
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, int)>(_Label->klass, "set_FontColor", 1)(_Label, GetEnumValue(ParseEnum(GetRuntimeType("umamusume.dll", "Gallop", "FontColorType"), color)));
	}
	...
	void NotificationManager::SetOutlineSize(il2cppstring size)
	{
		...
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, int)>(_Label->klass, "set_OutlineSize", 1)(_Label, GetEnumValue(ParseEnum(GetRuntimeType("umamusume.dll", "Gallop", "OutlineSizeType"), size)));
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*)>(_Label->klass, "UpdateOutline", 0)(_Label);
	}
	...
	void NotificationManager::SetOutlineColor(il2cppstring color)
	{
		...
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, int)>(_Label->klass, "set_OutlineColor", 1)(_Label, GetEnumValue(ParseEnum(GetRuntimeType("umamusume.dll", "Gallop", "OutlineColorType"), color)));
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*)>(_Label->klass, "RebuildOutline", 0)(_Label);
	}
	...
	void NotificationManager::SetBackgroundAlpha(float alpha)
	{
		...
		auto gameObject = il2cpp_symbols::get_method_pointer<Il2CppObject * (*)(Il2CppObject*)>(notification->klass, "get_gameObject", 0)(notification);
		...
		il2cpp_symbols::get_method_pointer<void (*)(Il2CppObject*, float)>(background->klass, "SetAlpha", 1)(background, alpha);
	}
